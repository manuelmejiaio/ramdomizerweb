...
const routes = [
  ...
  {
    path: '/account-change-password-confirmation',
    name: 'AccountChangePasswordConfirmation',
    component: () => import('@/views/AccountChangePasswordConfirmation.vue')
  },
  ...
  { path: '/account-delete', name: 'AccountDelete', component: () => import('@/views/AccountDelete.vue') },
  {
    ...
    component: () => import('@/views/AccountForgotPassword.vue')
  },
  ...
  {
    path: '/account-reset-password-email-sent',
    name: 'AccountResetPasswordEmailSent',
    component: () => import('@/views/AccountResetPasswordEmailSent.vue')
  },
  ...
  {
    path: '/giveaway-participants',
    name: 'GiveawayParticipants',
    component: () => import('@/views/GiveawayParticipants.vue')
  },
  ...
  {
    path: '/link/:giveawayId',
    name: 'GiveawayPublicLink',
    meta: { layout: 'no-header-no-footer' },
    component: () => import('@/views/GiveawayPublicLink.vue')
  },
